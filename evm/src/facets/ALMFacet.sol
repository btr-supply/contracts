...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 *
 * @title ALM Facet - Automated Liquidity Management logic
 * @copyright 2025
 * @notice Implements strategies for managing and rebalancing liquidity positions on DEXs
 * @dev Interacts with DEX adapters and ERC1155 Vaults
 * @author BTR Team
 */
