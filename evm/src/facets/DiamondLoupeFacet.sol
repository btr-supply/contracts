...
contract DiamondLoupeFacet is IDiamondLoupe, IERC165 {
    ...
    function supportsInterface(bytes4 _interfaceId) external view override returns (bool) {
        Diamond storage ds = S.diamond();
        return ds.supportedInterfaces[_interfaceId] || _interfaceId == type(IERC165).interfaceId
            || _interfaceId == type(IDiamondLoupe).interfaceId || _interfaceId == type(IERC721Receiver).interfaceId // rescuable
