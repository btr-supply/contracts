...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
 *
 * @title Managed Base - Base contract for managed ownership
 * @copyright 2025
 * @notice Abstract contract providing ownership management features
 * @dev Used for components requiring access control
 * @author BTR Team
 */
